...
Se trata de un contenedor del controlador MySQLjs/MySQL de Node, que envuelve las llamadas con promesas Bluebird. Es decir, mientras el controlador MySQLjs/MySQL utiliza \emph{callbacks}, promise-msqy soporta promesas.
